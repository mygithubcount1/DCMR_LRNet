...
if __name__ == '__main__':
    input_root = r'./dataset/soybean200/images'      # Original multi-level directory
    output_root = r'./dataset/soybean200/images_pytorch'    # Output keeps the same structure
    # input_root = r'./dataset/SoyAgeing/R6/images'      # Original multi-level directory
    # output_root = r'./dataset/SoyAgeing/R6/images_pytorch'    # Output keeps the same structure
