...
class FGDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        original_path = os.path.join(self.img_root, path)  

        # original_path: "002/002FZ_L_09.jpg"
        vein_path = path.replace('/', '/vein2_', 1)  
        vein_path = os.path.join(self.img_root, vein_path)  
